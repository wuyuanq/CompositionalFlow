...
program infile_RSTi_compositionalTwoPhaseFlow
    ...
    modelCase%Lx = 4.0
    modelCase%Ly = 4.0
    modelCase%timeEnd = 0.01*365*24*3600.0
    modelCase%nx = 40*times!!!!
    modelCase%ny = 40*times!!!!
    modelCase%nt = 0.01*365*24*10!!!!!

    call proceAlloc(512, modelCase%nx, modelCase%ny, modelCase%pncols, modelCase%pnrows)
