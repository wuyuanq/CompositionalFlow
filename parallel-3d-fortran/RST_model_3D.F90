...
module RST_model
    ...
    type :: model
        ...
        integer :: pnlays ! the number of layers of processes, for the parallel program
        ...
        real(kind=8) :: Lz ! the length of the reservoir in z-direction
        ...
        integer :: nz ! the number of cells in z-direction
        ...
        real(kind=8) :: gravZ ! the gravity in z-direction
        ...
        real(kind=8), dimension(:), pointer :: zs ! the grid points in z-direction
        ...
        real(kind=8), dimension(:,:,:), pointer :: Kzz ! the permeability in y-direction
        ...
        integer, dimension(:,:,:), pointer :: isDiriZ ! whether the boundary perpendicular with z-direction is Dirichlet condition, 1 means true, 0 means false
        ...
        real(kind=8), dimension(:,:,:), pointer :: PwBdryZ ! the pressure on the boundary perpendicular with z-direction
        ...
        real(kind=8), dimension(:,:,:,:), pointer :: zBdryZ ! the mole fraction on the boundary perpendicular with z-direction
        ...
        real(kind=8), dimension(:,:,:), pointer :: UwBdryZ ! the wetting velocities on the boundary perpendicular with z-direction
        ...
        real(kind=8), dimension(:,:,:), pointer :: UnBdryZ ! the nonwetting velocities on the boundary perpendicular with z-direction
