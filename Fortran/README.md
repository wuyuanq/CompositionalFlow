...
For example, if there are only 2 components and there are 129 points in p direction and 129 points in z1 direction, then TABLESIZE = 129*129. If there are 3 components and there are 17 points in p direction and 257 points in z1 direction and 257 points in z2 direction, then TABLESIZE = 17*(1+257)/2*257. 
