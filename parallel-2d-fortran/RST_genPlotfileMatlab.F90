...
contains
    ...
    subroutine genPlotfileMatlab()
        ...
        if(myid == 0) then
            ...
            write(10, fmt="(a)") "path('/Users/wuy/Dropbox/Research/CompositionalFlow_matlab/2D', path);"
            write(charNc,'(i2)') Nc
            ...
            write(10, fmt="(a)") "rmpath('/Users/wuy/Dropbox/Research/CompositionalFlow_matlab/2D');"
